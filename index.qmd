...
```{r}
#| label: Multilevel logistic models for neighborhood indicators and self-rated health (census tract random intercept)
...
final_table_ct %>%
  ...
  gt::tab_source_note(
    source_note = "Abbreviations: OR = Odds Ratio; CI = Confidence Interval. Each association was estimated in a separate multilevel logistic model with a random intercept for census tract, adjusted for sex, age group, race/color, and education."
  )
```

```{r}
#| label: Multilevel logistic models for neighborhood indicators and self-rated health stratified by sex (census tract random intercept)
#| code-summary: Multilevel logistic models for neighborhood indicators and self-rated health stratified by sex (census tract random intercept)
#| warning: false
#| message: false
